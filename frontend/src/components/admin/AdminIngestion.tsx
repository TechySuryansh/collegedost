...
/**
 * Admin Data Ingestion component.
 * Handles uploading AICTE CSV files and triggering NIRF checks.
 */
const AdminIngestion: React.FC = () => {
    ...
    const triggerNirf = async (): Promise<void> => {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Failed to trigger NIRF';
            alert(errorMessage);
        }
    };
